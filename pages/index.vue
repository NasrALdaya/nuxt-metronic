    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
      ...
      >
        ...
        >
          ...
          >
            <a href="../../demo32/dist/index.html">
              <img
                  alt="Logo"
                  src="~/assets/media/logos/demo32-small.svg"
                  class="h-25px d-lg-none"
              />
              <img
                  alt="Logo"
                  src="~/assets/media/logos/demo32.svg"
          ...
          >
                      ...
                      <div class="row">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                ...
                                >
                                      ...
                                      >
                                        <i
                                            class="ki-outline ki-element-11 text-primary fs-1"
                                        ></i>
                                      </span>
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/ecommerce.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-basket text-danger fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/projects.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-abstract-44 text-info fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/online-courses.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-color-swatch text-success fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/marketing.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-chart-simple text-dark fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/bidding.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-switch text-warning fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/pos.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-abstract-42 text-danger fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                            ...
                            <div class="col-lg-6 mb-3">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/dashboards/call-center.html"
                                    class="menu-link"
                                >
                                      <span
                                          class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3"
                                      >
                                        <i
                                            class="ki-outline ki-call text-primary fs-1"
                                        ></i>
                                      </span>
                                  <span class="d-flex flex-column">
                                        <span class="fs-6 fw-bold text-gray-800"
                        ...
                        >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/logistics.html"
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/website-analytics.html"
                                class="menu-link py-2"
                            >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/finance-performance.html"
                                class="menu-link py-2"
                            >
                                  <span class="menu-title"
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/store-analytics.html"
                                class="menu-link py-2"
                            >
                                  <span class="menu-title"
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/social.html"
                                class="menu-link py-2"
                            >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/delivery.html"
                                class="menu-link py-2"
                            >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/crypto.html"
                                class="menu-link py-2"
                            >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/school.html"
                                class="menu-link py-2"
                            >
                          ...
                          <div class="menu-item p-0 m-0">
                            <!--begin:Menu link-->
                            <a
                                href="../../demo32/dist/dashboards/podcast.html"
                                class="menu-link py-2"
                            >
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/overview.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Overview</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/projects.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Projects</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/campaigns.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Campaigns</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/documents.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Documents</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/followers.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Followers</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/pages/user-profile/activity.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Activity</span
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-6">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/about.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >About</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/team.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Our Team</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/contact.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Contact Us</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/licenses.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Licenses</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/sitemap.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Sitemap</span
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/careers/list.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Careers List</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/careers/apply.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Careers Apply</span
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-6">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/faq/classic.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >FAQ Classic</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/faq/extended.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >FAQ Extended</span
                                  ...
                                  <div class="mb-6">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/blog/home.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Blog Home</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/blog/post.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Blog Post</span
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/pricing.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Column Pricing</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/pricing/table.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Table Pricing</span
                                ...
                                <div class="col-lg-3 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/social/feeds.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Feeds</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/social/activity.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Activty</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/social/followers.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Followers</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/pages/social/settings.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Settings</span
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/overview.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Overview</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/settings.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Settings</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/security.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Security</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/activity.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Activity</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/billing.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Billing</span
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/statements.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Statements</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/referrals.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >Referrals</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/api-keys.html"
                                        class="menu-link"
                                    >
                                          <span class="menu-title"
                                          >API Keys</span
                                  ...
                                  <div class="menu-item p-0 m-0">
                                    <!--begin:Menu link-->
                                    <a
                                        href="../../demo32/dist/account/logs.html"
                                        class="menu-link"
                                    >
                            ...
                            <div class="col-lg-3 mb-6 mb-lg-0">
                              ...
                              <div class="mb-6">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/corporate/sign-in.html"
                                      class="menu-link"
                                  >
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/corporate/sign-up.html"
                                      class="menu-link"
                                  >
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/corporate/two-factor.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Two-Factor</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/corporate/reset-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Reset Password</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/corporate/new-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >New Password</span
                              ...
                              <div class="mb-0">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/overlay/sign-in.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-In</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/overlay/sign-up.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-Up</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/overlay/two-factor.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Two-Factor</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/overlay/reset-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Reset Password</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/overlay/new-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >New Password</span
                            ...
                            <div class="col-lg-3 mb-6 mb-lg-0">
                              ...
                              <div class="mb-6">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/creative/sign-in.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-in</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/creative/sign-up.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-up</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/creative/two-factor.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Two-Factor</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/creative/reset-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Reset Password</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/creative/new-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >New Password</span
                              ...
                              <div class="mb-6">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/fancy/sign-in.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-In</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/fancy/sign-up.html"
                                      class="menu-link"
                                  >
                                    <span class="menu-title">Sign-Up</span>
                                  </a>
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/fancy/two-factor.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Two-Factor</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/fancy/reset-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Reset Password</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/layouts/fancy/new-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >New Password</span
                            ...
                            <div class="col-lg-3 mb-6 mb-lg-0">
                              ...
                              <div class="mb-0">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/extended/multi-steps-sign-up.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/welcome.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/verify-email.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Verify Email</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/coming-soon.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Coming Soon</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/password-confirmation.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/account-deactivated.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/error-404.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Error 404</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/general/error-500.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Error 500</span
                            ...
                            <div class="col-lg-3 mb-6 mb-lg-0">
                              ...
                              <div class="mb-0">
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/welcome-message.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Welcome Message</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/reset-password.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                        >Reset Password</span
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/subscription-confirmed.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/card-declined.html"
                                      class="menu-link"
                                  >
                                        <span class="menu-title"
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/promo-1.html"
                                      class="menu-link"
                                  >
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/promo-2.html"
                                      class="menu-link"
                                  >
                                ...
                                <div class="menu-item p-0 m-0">
                                  <!--begin:Menu link-->
                                  <a
                                      href="../../demo32/dist/authentication/email/promo-3.html"
                                      class="menu-link"
                                  >
                                ...
                                <div class="col-lg-4 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/general/invite-friends.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Invite Friends</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/general/view-users.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >View Users</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/general/select-users.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Select Users</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/general/upgrade-plan.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Upgrade Plan</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/general/share-earn.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Share & Earn</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/forms/new-target.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >New Target</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/forms/new-card.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >New Card</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/forms/new-address.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >New Address</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/forms/create-api-key.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create API Key</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/forms/bidding.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Bidding</span
                                ...
                                <div class="col-lg-4 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-6">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/create-app.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create App</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/create-campaign.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/create-account.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/create-project.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create Project</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/top-up-wallet.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Top Up Wallet</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/offer-a-deal.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Offer a Deal</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/wizards/two-factor-authentication.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/search/horizontal.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Horizontal</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/search/vertical.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Vertical</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/search/users.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Users</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/modals/search/select-location.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                ...
                                <div class="col-lg-4 mb-6 mb-lg-0">
                                  ...
                                  <div class="mb-0">
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/horizontal.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Horizontal</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/vertical.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Vertical</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/two-factor-authentication.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Two Factor Auth</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/create-app.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create App</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/create-campaign.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create Campaign</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/create-account.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create Account</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/create-project.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Create Project</span
                                    ...
                                    <div class="menu-item p-0 m-0">
                                      <!--begin:Menu link-->
                                      <a
                                          href="../../demo32/dist/utilities/wizards/offer-a-deal.html"
                                          class="menu-link"
                                      >
                                            <span class="menu-title"
                                            >Offer a Deal</span
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-4 mb-6 mb-lg-0">
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/lists.html"
                                    class="menu-link"
                                >
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/statistics.html"
                                    class="menu-link"
                                >
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/charts.html"
                                    class="menu-link"
                                >
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/mixed.html"
                                    class="menu-link"
                                >
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/tables.html"
                                    class="menu-link"
                                >
                              ...
                              <div class="menu-item p-0 m-0">
                                <!--begin:Menu link-->
                                <a
                                    href="../../demo32/dist/widgets/feeds.html"
                                    class="menu-link"
                                >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/list.html"
                          >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/project.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/targets.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/budget.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/users.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/files.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/activity.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/projects/settings.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/products.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/categories.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/add-product.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/edit-product.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/add-category.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/catalog/edit-category.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/sales/listing.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/sales/details.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/sales/add-order.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/sales/edit-order.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/customers/listing.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/customers/details.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/reports/view.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/reports/sales.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/reports/returns.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/reports/customer-orders.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/ecommerce/reports/shipping.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/ecommerce/settings.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/support-center/overview.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/support-center/tickets/list.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/support-center/tickets/view.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/support-center/tutorials/list.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/support-center/tutorials/post.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/support-center/faq.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/support-center/licenses.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/support-center/contact.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/user-management/users/list.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/user-management/users/view.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/user-management/roles/list.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/user-management/roles/view.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/user-management/permissions.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/contacts/getting-started.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/contacts/add-contact.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/contacts/edit-contact.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/contacts/view-contact.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/subscriptions/getting-started.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/subscriptions/list.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/subscriptions/add.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/subscriptions/view.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/customers/getting-started.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/customers/list.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/customers/view.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/invoices/view/invoice-1.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/invoices/view/invoice-2.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                              ...
                              <a
                                  class="menu-link"
                                  href="../../demo32/dist/apps/invoices/view/invoice-3.html"
                              >
                                    <span class="menu-bullet">
                                      <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/invoices/create.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/file-manager/folders.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/file-manager/files.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/file-manager/blank.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/file-manager/settings.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/inbox/listing.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/inbox/compose.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/inbox/reply.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/chat/private.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/chat/group.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                        ...
                        <div class="menu-item">
                          ...
                          <a
                              class="menu-link"
                              href="../../demo32/dist/apps/chat/drawer.html"
                          >
                                <span class="menu-bullet">
                                  <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-item">
                      ...
                      <a
                          class="menu-link"
                          href="../../demo32/dist/apps/calendar.html"
                      >
                            <span class="menu-icon">
                ...
                >
                  ...
                  >
                    ...
                    <div class="menu-item">
                      ...
                      <a
                          class="menu-link"
                          href="https://preview.keenthemes.com/metronic8/demo32/layout-builder.html"
            ...
            <div class="app-navbar flex-shrink-0">
                  ...
                  >
                        ...
                        <div class="scroll-y mh-200px mh-lg-325px">
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-laptop fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-chart-simple fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-chart fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-chart-line-down fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-sms fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="symbol symbol-40px me-4">
                                  <span class="symbol-label bg-light">
                                    <i
                                        class="ki-outline ki-bank fs-2 text-primary"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                    ...
                    >
                      ...
                      <div class="d-flex justify-content-end">
                        ...
                        <a
                            href="../../demo32/dist/pages/search/horizontal.html"
              ...
              <div class="app-navbar-item ms-1 ms-lg-5">
                <!--begin::Menu- wrapper-->
                <div
                    class="btn btn-icon btn-color-white btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                    data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                  <span class="symbol-label bg-light-info">
                                    <i
                                        class="ki-outline ki-picture fs-2 text-info"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
              ...
              <div class="app-navbar-item ms-1 ms-lg-5">
                ...
                >
                  ...
                  >
                    ...
                    <!--begin::Status-->
                    <span
                        class="badge bg-primary text-inverse-primary py-2 px-3"
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-6">
                      ...
                      >
                        <i
                            class="ki-outline ki-dollar fs-3x text-primary mb-2"
                        ></i>
                    ...
                    <div class="col-6">
                      ...
                      >
                        <i
                            class="ki-outline ki-sms fs-3x text-primary mb-2"
                        ></i>
                        <span class="fs-5 fw-semibold text-gray-800 mb-0"
                        >Administration</span
                        >
                    ...
                    <div class="col-6">
                      ...
                      >
                        <i
                            class="ki-outline ki-abstract-41 fs-3x text-primary mb-2"
                        ></i>
                        <span class="fs-5 fw-semibold text-gray-800 mb-0"
                        >Projects</span
                        >
                    ...
                    <div class="col-6">
                      ...
                      >
                        <i
                            class="ki-outline ki-briefcase fs-3x text-primary mb-2"
                        ></i>
                        <span class="fs-5 fw-semibold text-gray-800 mb-0"
                        >Customers</span
                        >
              ...
              <div class="app-navbar-item ms-1 ms-lg-5">
                <!--begin::Menu wrapper-->
                <div
                    class="btn btn-icon btn-color-white btn-active-color-primary w-35px h-35px w-md-40px h-md-40px position-relative"
                    ...
                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                      ...
                      <div class="menu-item px-3">
                        ...
                        >Statements
                          ...
                          >
                                <i
                                    class="ki-outline ki-information-5 fs-5"
                                ></i> </span
                          ></a>
                      </div>
                      <!--end::Menu item-->
            ...
            <div class="d-flex flex-column flex-row-fluid">
              ...
              >
                <div class="btn btn-icon btn-custom h-65px w-65px me-6">
                  <img
                      alt="Logo"
                      src="~/assets/media/svg/misc/layer.svg"
                      class="h-40px"
                  />
                </div>
                <!--begin::Title-->
                ...
                >
                  ...
                  <span class="page-desc fs-6 fw-bold pt-4">
                        <i
                            class="ki-outline ki-star fs-6 text-warning me-2"
                        ></i>
                        <span class="custom-text me-3 lh-0">4.89</span>
                        <span class="d-flex align-items-center lh-0 fs-7"
                        >7,834 Reviews
                          <span class="bullet h-6px w-6px mx-3"></span>#1 Admin
              ...
              >
                ...
                >
                  ...
                  <div class="d-flex align-items-center flex-shrink-0">
                    <a
                        href="#"
                        class="btn btn-sm btn-flex btn-primary px-3"
                        data-bs-toggle="modal"
                    ...
                    <a
                        href="#"
                        class="btn btn-sm btn-flex btn-light ms-5"
                        data-bs-toggle="modal"
                ...
                <div class="row gx-5 gx-xl-10">
                        ...
                        <div class="m-0">
                          ...
                          <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="badge badge-light-danger fs-base">
                                  <i
                                      class="ki-outline ki-arrow-up fs-5 text-danger ms-n1"
                                  ></i
                                  >8.02%</span
                            >
                            <!--end::Label-->
                  ...
                  <div class="col-xxl-4 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                      ...
                      <!--begin::Body-->
                      <div
                          class="card-body d-flex align-items-end ps-4 pe-0 pb-4"
                      >
                        <!--begin::Chart-->
                        <div
                            id="kt_charts_widget_28"
                            class="h-300px w-100 min-h-auto"
                        ></div>
                        <!--end::Chart-->
                      </div>
                      <!--end::Body-->
                        ...
                        <div class="d-flex flex-stack">
                          ...
                          >
                            ...
                            <div class="me-5">
                              ...
                              <!--begin::Desc-->
                              <span
                                  class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0"
                              >Community</span
                              >
                              <!--end::Desc-->
                            </div>
                    ...
                    <div class="card card-flush h-xl-100">
                      ...
                      <div class="card-body py-3">
                        ...
                        <div class="table-responsive">
                          <!--begin::Table-->
                          <table
                              class="table table-row-dashed align-middle gs-0 gy-4"
                          >
                            <!--begin::Table head-->
                            <thead>
                            <tr
                                class="fs-7 fw-bold border-0 text-gray-400"
                            >
                              <th class="min-w-150px" colspan="2">
                                CAMPAIGN
                              </th>
                              <th
                                  class="min-w-150px text-end pe-0"
                                  colspan="2"
                              >
                                SESSIONS
                              </th>
                              <th
                                  class="text-end min-w-150px"
                                  colspan="2"
                              >
                                CONVERSION RATE
                              </th>
                            ...
                            <tr>
                              ...
                              <td class="" colspan="2">
                                <div class="d-flex justify-content-end">
                                        <span
                                            class="text-dark fw-bold fs-6 me-3"
                                        >23.63%</span
                                        >
                                  <span
                ...
                <div class="row gx-5 gx-xl-10">
                  ...
                  <div class="col-xl-6 mb-5 mb-xl-10">
                    ...
                    <div class="card card-flush h-xl-100">
                      ...
                      <!--begin::Body-->
                      <div
                          class="card-body d-flex justify-content-between flex-column py-3"
                      >
                        <!--begin::Block-->
                        <div class="m-0"></div>
                        <!--end::Block-->
                        ...
                        <div class="table-responsive mb-n2">
                          ...
                          <table class="table table-row-dashed gs-0 gy-4">
                            ...
                            <tr>
                              ...
                              >
                                      <span
                                          class="fw-bold text-gray-800 fs-6 me-3"
                                      >263</span
                                      >
                        ...
                        <div class="w-100">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-rocket fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                            ...
                            >
                              ...
                              <div class="d-flex align-items-center">
                                <!--begin::Number-->
                                <span
                                    class="text-gray-800 fw-bold fs-4 me-3"
                                >1,067</span
                                >
                                <!--end::Number-->
                                <!--begin::Info-->
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-tiktok fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-sms fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-icon fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-abstract-25 fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-30px me-5">
                                  <span class="symbol-label">
                                    <i
                                        class="ki-outline ki-abstract-39 fs-3 text-gray-600"
                                    ></i>
                                  </span>
                            </div>
                            <!--end::Symbol-->
                        ...
                        <div class="d-flex flex-wrap d-grid gap-5 mb-10">
                          ...
                          >
                            ...
                            <div class="d-flex mb-2">
                                  <span
                                      class="fs-4 fw-semibold text-gray-400 me-1"
                                  >$</span
                                  >
                              <span
                                  class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2"
          ...
          <div class="timeline">
            ...
            <div class="timeline-item">
              ...
              >
                <div class="symbol-label bg-light">
                  <i
                      class="ki-outline ki-message-text-2 fs-2 text-gray-500"
                  ></i>
                </div>
              </div>
              <!--end::Timeline icon-->
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-icon symbol symbol-circle symbol-40px">
                <div class="symbol-label bg-light">
                  <i
                      class="ki-outline ki-disconnect fs-2 text-gray-500"
                  ></i>
                </div>
              </div>
              <!--end::Timeline icon-->
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    ...
                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                      <!--begin::Icon-->
                      <img
                          alt="../../demo32/dist/apps/projects/project.html"
                          class="w-30px me-3"
            ...
            <div class="timeline-item">
              ...
              <div class="timeline-icon symbol symbol-circle symbol-40px">
                <div class="symbol-label bg-light">
                  <i
                      class="ki-outline ki-abstract-26 fs-2 text-gray-500"
                  ></i>
                </div>
              </div>
              <!--end::Timeline icon-->
              ...
              <div class="timeline-content mb-10 mt-n1">
                ...
                <div class="overflow-auto pb-5">
                  ...
                  >
                    <!--begin::Icon-->
                    <i
                        class="ki-outline ki-devices-2 fs-2tx text-primary me-4"
                    ></i>
                    <!--end::Icon-->
                    <!--begin::Wrapper-->
                    <div
                  ...
                  >
                    ...
                    <div class="pt-1">
                      ...
                      <div class="d-flex align-items-center mb-7">
                            ...
                            >
                        <i
                            class="ki-outline ki-check-circle fs-1 text-success"
                        ></i>
                      </div>
                      <!--end::Item-->
                      <!--begin::Item-->
            ...
            <div class="row g-9 mb-8">
              ...
              <div class="col-md-6 fv-row">
                ...
                <div class="position-relative d-flex align-items-center">
                  <!--begin::Icon-->
                  <i
                      class="ki-outline ki-calendar-8 fs-2 position-absolute mx-4"
                  ></i>
                  <!--end::Icon-->
                  <!--begin::Datepicker-->
                  <input
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
          ...
          >
            ...
            >
              ...
              <!--begin::Icon-->
              <i
                  class="ki-outline ki-magnifier fs-2 fs-lg-1 text-gray-500 position-absolute top-50 ms-5 translate-middle-y"
              ></i>
              <!--end::Icon-->
              <!--begin::Input-->
              <input
